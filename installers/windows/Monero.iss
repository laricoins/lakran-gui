...
Name: "{group}\GUI Wallet"; Filename: "{app}\lakran-wallet-gui.exe"
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\lakran-wallet-cli.exe"; WorkingDir: "{userdocs}\Monero\wallets"
